...
Vou continuar a correção do layout de navegação do DashboardAnalista, removendo a barra duplicada:

<dyad-write path="src/pages/DashboardAnalista.tsx" description="Removing duplicate navigation from analista dashboard">
import { useState } from "react";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
