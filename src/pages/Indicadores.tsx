      ...
      <div className="container mx-auto px-4 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{indicadoresGerais.total_propostas}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{indicadoresGerais.propostas_aprovadas}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{indicadoresGerais.taxa_aprovacao}%</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{indicadoresGerais.total_artistas}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">R$ {indicadoresGerais.total_investido.toLocaleString()}</div>
          ...
          <TabsContent value="areas" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={dadosAreaCultural}>
